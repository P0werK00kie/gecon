  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{ backgroundImage: "url('https://gecon-roofing.websitepro.hosting/wp-content/uploads/2021/05/civil1.jpg')" }}
      >
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            >
              <div 
                ...
                style={{ backgroundImage: "url('https://gecon-roofing.websitepro.hosting/wp-content/uploads/2021/05/civil2.jpg')" }}
              ></div>
            </motion.div>
